...
// export const CONFIG = {
//   REGION: 'eu-central-1',
//   USERPOOLID: 'eu-central-1_bS7gL2NH2', // please add you cognito user pool id, you can run amplify auth console and select 'User Pool option'
...
const CONFIG = {
    REGION: 'us-east-1',
    USERPOOLID: 'us-east-1_vunkelSrL',
    // https://cognito-idp.eu-central-1.amazonaws.com/eu-central-1_bS7gL2NH2/.well-known/jwks.json
    JWKS: { "keys": [{ "alg": "RS256", "e": "AQAB", "kid": "sVqopRxeXD8feD/IUU0MwsieQU0hizBuWMPeq8/J4wo=", "kty": "RSA", "n": "0qlVsurUUlwzDbH11qnrd6W4YxVQboIFnLzs8d7IsUQGTJUSuLuvKSRMCHZSg2N3_EzPDyZTTApPfYr4uMk-yGWeqCF25GUHWIjqTD9xmPzSOOHyzHsQyGI3av5P9Fzq337XAE7GxxeVbuQ5dstQU57mnGlzV7-i9bsPGVapMM3rf5DjJHfxvtJBgXdmgsYTlJDd7loSvIeVhS1DojAlSPm0rjosXy0Wp5akKaNW2MIaNMcL8Qbeye61v9msiGorpSi1eFyeu686MM9pebfjj6lpipOGKCSh-pQyoA646bcwtP74KIWAj0C2nBDhTQOUm2NWZH3YCDwTuLVIwoNSAQ", "use": "sig" }, { "alg": "RS256", "e": "AQAB", "kid": "rg04YpCI873FphU9XWuRGSF9j7Ot+0VzBK3R5Y3gMJ4=", "kty": "RSA", "n": "r0kQ8zMQr47iPPVgqnzAvvVp4-KSnfzWtW4euNomg7rMTTBiijufceSuuE2907-MznjAjLOyxMTPNCRQGSNZ5KZPiTAepXDClGHAlPOtwYRTAoIpPdPzHitk4QD4URV9w4buA5i5HrRZrDsura1vQsXVvToT2TnYjOvtfJUh8ocPPY3-mz-NZOQvNYgSz1_XjkHVzro7qV5iKt6Oa1tp8yW1URuUEVwp7HlK8NssK0qxFktrXWv6XzWekSb8Z2q0uTh4PSD_fGPFQi11KZiiQ84AUGS8J-FCC25yfSff2T2F68onLI1SZlO0vIHJc5nZLJx39_jSrtXX0HlgTOqOGw", "use": "sig" }] }
};
...
const authenticateRequest = async (token) => {
    ...
    return new Promise((resolve, reject) => {
        ...
        // UserPool check
        if (((_a = decodedJwt === null || decodedJwt === void 0 ? void 0 : decodedJwt.payload) === null || _a === void 0 ? void 0 : _a.iss) != iss) {
            return reject(new Error("invalid issuer, check config.js"));
        }
        //Reject the jwt if it's not an 'Access Token'
        if ((decodedJwt === null || decodedJwt === void 0 ? void 0 : decodedJwt.payload.token_use) != 'access') {
            console.log();
            return reject(new Error("Not an access token"));
        }
        //Get the kid from the token and retrieve corresponding PEM
        const kid = decodedJwt === null || decodedJwt === void 0 ? void 0 : decodedJwt.header.kid;
        const pem = pems[kid];
        if (!pem) {
            return reject(new Error('Invalid access token'));
        }
        //Verify the signature of the JWT token to ensure it's really coming from your User Pool
        jsonwebtoken.verify(jwtToken, pem, { issuer: iss }, function (err) {
            if (err) {
                return reject(err);
            }
            else {
